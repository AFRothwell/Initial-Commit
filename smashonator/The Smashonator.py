    ...
    if player.health <= 0:
        ...
        if turn == 0 and player.health > 0:
            ...
            while (player_input != "attack" or "heal") and turn == 0:
                if player_input == "attack":
                    ...
                    print("You attack the Great Smashonator for {} HP! They have {} health left!".format(resolved_attack,enemy.health))
                    turn = 1
        ...
        if turn == 1 and enemy.health > 0:
            ...
            if ai_input == 1:
                ...
                print("The Great Smashonator smashes you for {} HP! You have {} health left!".format(resolved_attack, player.health))
                turn = 0
            elif ai_input == 2:
                resolved_heal = Enemy.heal(enemy)
                enemy.health += resolved_heal
                print("The Great Smashonator heals for {} HP! They have {} health left!".format(resolved_heal, enemy.health))
                turn = 0